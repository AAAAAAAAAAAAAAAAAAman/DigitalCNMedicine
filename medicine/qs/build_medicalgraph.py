...
class MedicalGraph:
    def __init__(self):
        ...
        self.g = Graph("bolt://[YOUR_IP]:7687", user="YOUR_NAME", password="YOUR_PASSWORD")  # 示例：  self.g = Graph("bolt://117.130.140.253:7687", user="neo4j", password="12345678")
    '''读取文件'''
    ...
    def create_diseases_nodes(self, disease_infos):
        ...
        for disease_dict in disease_infos:
            node = Node("Disease", name=disease_dict['name'], desc=disease_dict['desc'],
                        ...
                        , cure_way=disease_dict['cure_way'], cured_prob=disease_dict['cured_prob'],cost_money=disease_dict['cost_money'],get_way=disease_dict['get_way'])
            self.g.create(node)
            count += 1
            print(count)
        return
